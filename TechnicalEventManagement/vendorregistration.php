                ...
                <div class="col-sm-12 shadow-lg p-3 mb-5 bg-white rounded my-5">
                    ...
                    <center>
                        <div class=" col-sm-6 shadow p-3 mb-5 bg-warning rounded" style="margin-top: 45px;">
                            <div class="">
                                <h1 style="color:blue;text-align: center;">Vendor Registration</h1>

                                <form class="form-group" id="contactUsForm">
<input type="hidden" name="vendor" value="vendorregistration">
                                    ...
                                    <center> <button style="color:white" class="btn btn-success">Sign Up</button>
                                    </center>
    ...
    <script>
        $(document).ready(function () {
            $("#contactUsForm").submit(function (event) {
                ...
                var login_type = $("#category").val();
                if (login_type == "null") {
                    $("#er").text("Please Select Category.");
                } else {
                    $.ajax({
                        type: "POST",
